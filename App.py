...
_defaults = dict(
    ...
    input_data=None, scaled_input_df=None, input_data_scaled_raw=None,
...
# ═══════════════════════════════════════════════════════════════════
    ...
    with st.expander("Technical — Model Input Diagnostics"):
        st.caption("Raw feature values (before scaling)")
        st.dataframe(input_data, use_container_width=True)
        st.caption("Scaled values (StandardScaler output)")
        st.dataframe(scaled_input_df, use_container_width=True)
    ...
    # ── SAVE STATE ────────────────────────────────────────────────
        ...
        st.session_state.update(dict(
            ...
            scaled_input_df=scaled_input_df,
            input_data_scaled_raw=input_data_scaled,
